...
-- AddForeignKey
ALTER TABLE "Playist" ADD CONSTRAINT "Playist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
